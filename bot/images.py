...
def generate_profile_image(user):
    ...
    # Load nebula FIRST so text appears on top
    ...
    # Grok sprite last (on top of everything)
...
def generate_leaderboard_image():
    rows = get_top_users()   # [{ user_id, xp, level, form }, ...]
